...
See the [https://code.google.com/archive/p/gag/](Google Annotations Gallery) ('gag') for some humorous custom annotations that I sometimes wish I could use in production code!
